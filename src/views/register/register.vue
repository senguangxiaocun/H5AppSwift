  ...
  <div class="page">
    ...
    <div class="content">
      ...
      <div class="fourth-section">
        <div class="save-btn" @click="saveProfile">Sign Up Now</div>
      </div>
    </div>
  </div>
</template>
...
.gender-box {
  ...
  background: rgba(245, 245, 245, 1);
  border-radius: calc(100vh * 22 / 812);
  display: flex;
  justify-content: center;
  align-items: center;
...
.save-btn {
  ...
  height: calc(100vh * 54 / 812);
  border-radius: calc(100vh * 27 / 812);
  background: rgba(201, 238, 64, 1);
