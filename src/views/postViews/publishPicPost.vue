  ...
  <div class="page">
    ...
    <div class="page-content">
      ...
      <div class="theme-list">
        <div
          v-for="(theme, index) in otherStore.other.postTheme"
          :key="index"
          class="theme-item"
      ...
      <div class="upload-list">
        <!-- 添加图片按钮 -->
        <label v-if="uploadedImagesFiles.length < maxImages" class="upload-item">
          <input
            type="file"
            accept="image/*"
            multiple
            ...
            <div
              ...
              :style="{
                backgroundImage: file
                  ? `url(${
                      file.preview || file._previewUrl || URL.createObjectURL(file)
                    })`
                  : '',
              }"
            ></div>
      ...
      <!-- Release -->
      <div class="release-button" @click="showGoToLoginPost">Release</div>
    </div>
  </div>
</template>
