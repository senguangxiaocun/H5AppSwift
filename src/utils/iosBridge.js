...
export function sendPaymentToIOS(payKey) {
  try {
    if (window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.payment) {
...
export function sendShowToastToIOS(toastMsg) {
  try {
    if (window.webkit && window.webkit.messageHandlers && window.webkit.messageHandlers.showToast) {
